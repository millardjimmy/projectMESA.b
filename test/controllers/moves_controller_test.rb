...
class MovesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post moves_url, params: { move: { date: @move.date, name: @move.name, user_id: @move.user_id } }
    end
  ...
  test "should update move" do
    patch move_url(@move), params: { move: { date: @move.date, name: @move.name, user_id: @move.user_id } }
